import config from "components/CountriesTable/config";
...
const cells = {
  ...
  hoverState: {
    '&[class*="todayDeathsCell"]': {
      background:
        config.colors.background.hovers.todayDeathsCell + " !important",
    },
    '&[class*="newCasesTodayCell"]': {
      background:
        config.colors.background.hovers.newCasesTodayCell + " !important",
    },
  },
};
